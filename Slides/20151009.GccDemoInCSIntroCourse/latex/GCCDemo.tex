...
\frame{
  \frametitle{Appendix: ubuntu 安装 eclipse-cdt}
  \href{http://mirror.cc.columbia.edu/pub/software/eclipse/technology/epp/downloads/release/mars/1/eclipse-cpp-mars-1-linux-gtk-x86_64.tar.gz}{64位下载地址}
}
\frame{
  \frametitle{Summary}
  \begin{tikzpicture}
